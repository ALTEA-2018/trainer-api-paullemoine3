...
public class TrainerControllerIntegrationTest {
    ...
    public void createTrainer_shouldReturnAshTest() {
        ...
        this.restTemplate.postForEntity("http://localhost:" + port + "/trainers/", t, Trainer.class);
        var ashTest =this.restTemplate.getForObject("http://localhost:" + port + "/trainers/AshTest", Trainer.class);
    ...
    public void updateTrainer_shouldReturnUpdateAsh() {
        ...
        this.restTemplate.put("http://localhost:" + port + "/trainers/", t, Trainer.class);
        var ash =this.restTemplate.getForObject("http://localhost:" + port + "/trainers/Ash", Trainer.class);
                assertNotNull(ash);
        assertEquals("Ash", ash.getName());
        assertEquals(1, ash.getTeam().size());
